...
export interface Gig {
  ...
  price: number;
  dueDate: Timestamp;
  status: "open" | "in-progress" | "awaiting-confirmation" | "completed" | "deleted" | "problem-reported"; 
  listerId: string;
...
export interface Application {
  ...
  listerId: string;
  coverLetter: string;
  status: "pending" | "discarded" |  "assigned" | "awaiting-lister-completion" | "completed" ;
  appliedAt: Timestamp;
  chatId: string;
}
