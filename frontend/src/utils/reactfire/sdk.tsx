...
export const AppCheckSdkContext = React.createContext<AppCheck | undefined>(
  undefined,
);
export const AuthSdkContext = React.createContext<Auth | undefined>(undefined);
export const AnalyticsSdkContext = React.createContext<Analytics | undefined>(
  undefined,
);
export const DatabaseSdkContext = React.createContext<Database | undefined>(
  undefined,
);
export const FirestoreSdkContext = React.createContext<Firestore | undefined>(
  undefined,
);
export const FunctionsSdkContext = React.createContext<Functions | undefined>(
  undefined,
);
export const StorageSdkContext = React.createContext<
  FirebaseStorage | undefined
>(undefined);
export const PerformanceSdkContext = React.createContext<
  FirebasePerformance | undefined
>(undefined);
export const RemoteConfigSdkContext = React.createContext<
...
function useInitSdk<Sdk extends FirebaseSdks>(
  ...
  return useObservable<Sdk>(
    `firebase-sdk:${sdkName}:${firebaseApp.name}`,
    from(initializeSdk),
    options,
  );
}
...
export const useInitPerformance: InitSdkHook<FirebasePerformance> = (
  ...
  useInitSdk<FirebasePerformance>(
    "performance",
    PerformanceSdkContext,
    initializer,
    options,
